...
describe('address', function () {
    it('ed25519', function () {
        ...
        var bytes = new Uint8Array(crypto.randomBytes(32));
        var key = new __1.proto.cosmos.crypto.ed25519.PrivKey({ key: bytes });
        var address = __1.cosmosclient.AccAddress.fromPublicKey(key.pubKey());
        var str = address.toString();
        var revived = __1.cosmosclient.AccAddress.fromString(str);
        expect(revived.toString()).toStrictEqual(str);
        var valAddress = __1.cosmosclient.ValAddress.fromPublicKey(key.pubKey());
    ...
    it('accaddress', function () { return __awaiter(void 0, void 0, void 0, function () {
        var privKeyStr, privKey1, privKey2, address1, address2;
        return __generator(this, function (_a) {
            expect.hasAssertions();
            privKeyStr = 'ef40ea14839c3ee5690336bb1f032870941dbb329fc0553132a4a109a022a391';
            privKey1 = new __1.proto.cosmos.crypto.ed25519.PrivKey({
                key: Buffer.from(privKeyStr, 'hex'),
            });
            privKey2 = new __1.proto.cosmos.crypto.secp256k1.PrivKey({
                key: Buffer.from(privKeyStr, 'hex'),
            });
            address1 = __1.cosmosclient.AccAddress.fromPublicKey(privKey1.pubKey());
            address2 = __1.cosmosclient.AccAddress.fromPublicKey(privKey2.pubKey());
    ...
    it('convert', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            expect.hasAssertions();
            privKeyStr = 'ef40ea14839c3ee5690336bb1f032870941dbb329fc0553132a4a109a022a391';
            privKey = new __1.proto.cosmos.crypto.secp256k1.PrivKey({
                key: Buffer.from(privKeyStr, 'hex'),
            });
