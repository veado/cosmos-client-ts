...
describe('codec', function () {
    it('txBuilder', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    authInfo = new __1.proto.cosmos.tx.v1beta1.AuthInfo({
                        signer_infos: [
                            {
                                public_key: __1.cosmosclient.codec.instanceToProtoAny(pubKey),
                                mode_info: {
                                    single: {
                                        mode: __1.proto.cosmos.tx.signing.v1beta1.SignMode.SIGN_MODE_DIRECT,
                                    },
                                },
                                sequence: long_1.default.fromNumber(0),
                            },
                        ],
                        fee: {
                    ...
                    json = txBuilder.protoJSONStringify(2);
                    console.log(json);
    ...
    it('protoJSONStringify', function () {
        expect.hasAssertions();
        var account = {
        ...
        var unpacked = __1.cosmosclient.codec.protoJSONToInstance(account);
        if (!(unpacked instanceof __1.proto.cosmos.auth.v1beta1.BaseAccount)) {
            throw Error('');
        }
        var json = __1.cosmosclient.codec.instanceToProtoJSON(unpacked);
        console.log(json);
        expect(true).toBeTruthy();
    });
    it('protoJSONToInstance', function () {
        expect.hasAssertions();
        var res = {
            data: {
                account: {
        ...
        var unpacked = __1.cosmosclient.codec.protoJSONToInstance(res.data.account);
        if (!(unpacked instanceof __1.proto.cosmos.auth.v1beta1.BaseAccount)) {
            throw Error('');
        }
        console.log(unpacked);
        var key = __1.cosmosclient.codec.protoAnyToInstance(unpacked.pub_key);
        console.log(key);
        expect(true).toBeTruthy();
    });
    ...
    it('protoJSONToInstanceTxMsg', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sdk, hashSend, txResponce, messase, cast, instance, hashSubmit, txResponceS, instanceProposal;
        var _a, _b, _c, _d, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    expect.hasAssertions();
                    sdk = new __1.cosmosclient.CosmosSDK('https://ununifi-alpha-test-v2.cauchye.net:1318', 'ununifi-alpha-test-v2');
                    hashSend = "AF78448BFBF4725FA9EF8382B52743210B6EBC3B02BE26C2BCB288202F0DE73B" //msgSend 100uguu
                    ;
                    return [4 /*yield*/, __1.rest.tx.getTx(sdk, hashSend).then(function (res) { return res.data; })];
                case 1:
                    txResponce = _g.sent();
                    messase = (_c = (_b = (_a = txResponce.tx) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.messages) === null || _c === void 0 ? void 0 : _c[0];
                    cast = __1.cosmosclient.codec.castProtoJSONOfProtoAny(messase);
                    instance = __1.cosmosclient.codec.protoJSONToInstance(cast);
                    expect(instance.constructor.name).toBe("MsgSend");
                    console.log("cast-msgSend", cast);
                    console.log("instanceMsgSend", instance);
                    hashSubmit = "8B21739E3568727D0C30E469910359643E2B85E88B0B223E644566692721F5D8" //msgSubmitProposal
                    ;
                    return [4 /*yield*/, __1.rest.tx.getTx(sdk, hashSubmit).then(function (res) { return res.data; })];
                case 2:
                    txResponceS = _g.sent();
                    instanceProposal = __1.cosmosclient.codec.protoJSONToInstance(__1.cosmosclient.codec.castProtoJSONOfProtoAny((_f = (_e = (_d = txResponceS.tx) === null || _d === void 0 ? void 0 : _d.body) === null || _e === void 0 ? void 0 : _e.messages) === null || _f === void 0 ? void 0 : _f[0]));
                    expect(instanceProposal.constructor.name).toBe("MsgSubmitProposal");
