...
describe('multisig', function () {
    it('multisig_address', function () { return __awaiter(void 0, void 0, void 0, function () {
        var multisig, publicKey, multisigAddress;
        return __generator(this, function (_a) {
            ...
            publicKey = __1.cosmosclient.codec.protoJSONToInstance(multisig);
            console.log(publicKey);
            multisigAddress = __1.cosmosclient.AccAddress.fromPublicKey(publicKey);
