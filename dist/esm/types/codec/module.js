...
export function instanceToProtoJSON(value) {
    ...
    if (value instanceof google.protobuf.Any) {
        ...
        const constructor = instance === null || instance === void 0 ? void 0 : instance.constructor;
    ...
    const prototype = constructor === null || constructor === void 0 ? void 0 : constructor.prototype;
