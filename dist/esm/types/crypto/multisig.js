...
function encodeAminoPubkey(pubkey) {
    if (pubkey instanceof cosmos.crypto.ed25519.PubKey) {
        ...
        for (const keyData of pubkey.public_keys.map((key) => encodeAminoPubkey(codec.protoAnyToInstance(key)))) {
...
cosmos.crypto.multisig.LegacyAminoPubKey.prototype.verify = function (_, sig) {
